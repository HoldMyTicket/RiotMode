...
riot.tag('rm-toast', '<div show="{displayToast}" class="message-container"> <div onclick="{hideToast}" class="toast { toastPosition }">{ parseHTML(opts.text) }</div> </div>', 'rm-toast .toast, [riot-tag="rm-toast"] .toast{ position: absolute; margin: 20px; max-width: 200px; color: rgba(255, 255, 255, 1); background-color: rgba(0, 0, 0, 0.8); padding: 20px; -webkit-border-radius: 5px; -moz-border-radius: 5px; -o-border-radius: 5px; border-radius: 5px; } rm-toast .top-left, [riot-tag="rm-toast"] .top-left{ top: 0; left: 0; } rm-toast .top-right, [riot-tag="rm-toast"] .top-right{ top: 0; right: 0; } rm-toast .bottom-left, [riot-tag="rm-toast"] .bottom-left{ left: 0; bottom: 0; } rm-toast .bottom-right, [riot-tag="rm-toast"] .bottom-right{ right: 0; bottom: 0; }', function(opts) {
