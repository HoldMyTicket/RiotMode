...
riot.tag('rm-awesome-table', '<table class="awesometable { tableType }"> <thead> <tr> <th each="{ headerContent, i in opts.tableHeaders}">{ headerContent }</th> </tr> </thead> <tbody> <tr each="{ bodyContentRows, i in opts.tableContent }"> <td each="{ bodyContentData, i in bodyContentRows }">{ bodyContentData }</td> </tr> </tbody> <tfoot> <tr> <td each="{ footerContent, i in opts.tableFooter }">{ footerContent }</td> </tr> </tfoot> </table>', 'rm-awesome-table .awesometable, [riot-tag="rm-awesome-table"] .awesometable{ width: 100%; margin-bottom: 20px; max-width: 100%; background-color: transparent; border-collapse: collapse; border-spacing: 0; font-family: helvetica; } rm-awesome-table .awesometable-fixed, [riot-tag="rm-awesome-table"] .awesometable-fixed{ table-layout: fixed; } rm-awesome-table .awesometable th, [riot-tag="rm-awesome-table"] .awesometable th,rm-awesome-table .awesometable td, [riot-tag="rm-awesome-table"] .awesometable td{ padding: 8px; line-height: 20px; text-align: left; vertical-align: top; border-top: 1px solid #dddddd; font-family: helvetica; } rm-awesome-table .awesometable.awesometable-small td, [riot-tag="rm-awesome-table"] .awesometable.awesometable-small td,rm-awesome-table .awesometable.awesometable-small th, [riot-tag="rm-awesome-table"] .awesometable.awesometable-small th{ font-size: 10px; } rm-awesome-table .awesometable th, [riot-tag="rm-awesome-table"] .awesometable th{ font-weight: bold; font-size: 11px; } rm-awesome-table .awesometable thead th, [riot-tag="rm-awesome-table"] .awesometable thead th{ vertical-align: bottom; } rm-awesome-table .awesometable caption + thead tr:first-child th, [riot-tag="rm-awesome-table"] .awesometable caption + thead tr:first-child th,rm-awesome-table .awesometable caption + thead tr:first-child td, [riot-tag="rm-awesome-table"] .awesometable caption + thead tr:first-child td,rm-awesome-table .awesometable colgroup + thead tr:first-child th, [riot-tag="rm-awesome-table"] .awesometable colgroup + thead tr:first-child th,rm-awesome-table .awesometable colgroup + thead tr:first-child td, [riot-tag="rm-awesome-table"] .awesometable colgroup + thead tr:first-child td,rm-awesome-table .awesometable thead:first-child tr:first-child th, [riot-tag="rm-awesome-table"] .awesometable thead:first-child tr:first-child th,rm-awesome-table .awesometable thead:first-child tr:first-child td, [riot-tag="rm-awesome-table"] .awesometable thead:first-child tr:first-child td{ border-top: 0; } rm-awesome-table .awesometable tbody + tbody, [riot-tag="rm-awesome-table"] .awesometable tbody + tbody{ border-top: 2px solid #dddddd; } rm-awesome-table .awesometable .awesometable, [riot-tag="rm-awesome-table"] .awesometable .awesometable{ background-color: #ffffff; } rm-awesome-table .awesometable-condensed th, [riot-tag="rm-awesome-table"] .awesometable-condensed th,rm-awesome-table .awesometable-condensed td, [riot-tag="rm-awesome-table"] .awesometable-condensed td{ padding: 4px 5px; font-size: 11px; } rm-awesome-table .awesometable-bordered, [riot-tag="rm-awesome-table"] .awesometable-bordered{ border: 1px solid #dddddd; border-collapse: separate; *border-collapse: collapse; border-left: 0; -webkit-border-radius: 4px; -moz-border-radius: 4px; border-radius: 4px; } rm-awesome-table .awesometable-bordered th, [riot-tag="rm-awesome-table"] .awesometable-bordered th,rm-awesome-table .awesometable-bordered td, [riot-tag="rm-awesome-table"] .awesometable-bordered td{ border-left: 1px solid #dddddd; } rm-awesome-table .awesometable-bordered caption + thead tr:first-child th, [riot-tag="rm-awesome-table"] .awesometable-bordered caption + thead tr:first-child th,rm-awesome-table .awesometable-bordered caption + tbody tr:first-child th, [riot-tag="rm-awesome-table"] .awesometable-bordered caption + tbody tr:first-child th,rm-awesome-table .awesometable-bordered caption + tbody tr:first-child td, [riot-tag="rm-awesome-table"] .awesometable-bordered caption + tbody tr:first-child td,rm-awesome-table .awesometable-bordered colgroup + thead tr:first-child th, [riot-tag="rm-awesome-table"] .awesometable-bordered colgroup + thead tr:first-child th,rm-awesome-table .awesometable-bordered colgroup + tbody tr:first-child th, [riot-tag="rm-awesome-table"] .awesometable-bordered colgroup + tbody tr:first-child th,rm-awesome-table .awesometable-bordered colgroup + tbody tr:first-child td, [riot-tag="rm-awesome-table"] .awesometable-bordered colgroup + tbody tr:first-child td,rm-awesome-table .awesometable-bordered thead:first-child tr:first-child th, [riot-tag="rm-awesome-table"] .awesometable-bordered thead:first-child tr:first-child th,rm-awesome-table .awesometable-bordered tbody:first-child tr:first-child th, [riot-tag="rm-awesome-table"] .awesometable-bordered tbody:first-child tr:first-child th,rm-awesome-table .awesometable-bordered tbody:first-child tr:first-child td, [riot-tag="rm-awesome-table"] .awesometable-bordered tbody:first-child tr:first-child td{ border-top: 0; } rm-awesome-table .awesometable-bordered thead:first-child tr:first-child > th:first-child, [riot-tag="rm-awesome-table"] .awesometable-bordered thead:first-child tr:first-child > th:first-child,rm-awesome-table .awesometable-bordered tbody:first-child tr:first-child > td:first-child, [riot-tag="rm-awesome-table"] .awesometable-bordered tbody:first-child tr:first-child > td:first-child{ -webkit-border-top-left-radius: 4px; -moz-border-radius-topleft: 4px; border-top-left-radius: 4px; } rm-awesome-table .awesometable-bordered thead:first-child tr:first-child > th:last-child, [riot-tag="rm-awesome-table"] .awesometable-bordered thead:first-child tr:first-child > th:last-child,rm-awesome-table .awesometable-bordered tbody:first-child tr:first-child > td:last-child, [riot-tag="rm-awesome-table"] .awesometable-bordered tbody:first-child tr:first-child > td:last-child{ -webkit-border-top-right-radius: 4px; -moz-border-radius-topright: 4px; border-top-right-radius: 4px; } rm-awesome-table .awesometable-bordered thead:last-child tr:last-child > th:first-child, [riot-tag="rm-awesome-table"] .awesometable-bordered thead:last-child tr:last-child > th:first-child,rm-awesome-table .awesometable-bordered tbody:last-child tr:last-child > td:first-child, [riot-tag="rm-awesome-table"] .awesometable-bordered tbody:last-child tr:last-child > td:first-child,rm-awesome-table .awesometable-bordered tfoot:last-child tr:last-child > td:first-child, [riot-tag="rm-awesome-table"] .awesometable-bordered tfoot:last-child tr:last-child > td:first-child{ -webkit-border-bottom-left-radius: 4px; -moz-border-radius-bottomleft: 4px; border-bottom-left-radius: 4px; } rm-awesome-table .awesometable-bordered thead:last-child tr:last-child > th:last-child, [riot-tag="rm-awesome-table"] .awesometable-bordered thead:last-child tr:last-child > th:last-child,rm-awesome-table .awesometable-bordered tbody:last-child tr:last-child > td:last-child, [riot-tag="rm-awesome-table"] .awesometable-bordered tbody:last-child tr:last-child > td:last-child,rm-awesome-table .awesometable-bordered tfoot:last-child tr:last-child > td:last-child, [riot-tag="rm-awesome-table"] .awesometable-bordered tfoot:last-child tr:last-child > td:last-child{ -webkit-border-bottom-right-radius: 4px; -moz-border-radius-bottomright: 4px; border-bottom-right-radius: 4px; } rm-awesome-table .awesometable-bordered tfoot + tbody:last-child tr:last-child td:first-child, [riot-tag="rm-awesome-table"] .awesometable-bordered tfoot + tbody:last-child tr:last-child td:first-child{ -webkit-border-bottom-left-radius: 0; -moz-border-radius-bottomleft: 0; border-bottom-left-radius: 0; } rm-awesome-table .awesometable-bordered tfoot + tbody:last-child tr:last-child td:last-child, [riot-tag="rm-awesome-table"] .awesometable-bordered tfoot + tbody:last-child tr:last-child td:last-child{ -webkit-border-bottom-right-radius: 0; -moz-border-radius-bottomright: 0; border-bottom-right-radius: 0; } rm-awesome-table .awesometable-bordered caption + thead tr:first-child th:first-child, [riot-tag="rm-awesome-table"] .awesometable-bordered caption + thead tr:first-child th:first-child,rm-awesome-table .awesometable-bordered caption + tbody tr:first-child td:first-child, [riot-tag="rm-awesome-table"] .awesometable-bordered caption + tbody tr:first-child td:first-child,rm-awesome-table .awesometable-bordered colgroup + thead tr:first-child th:first-child, [riot-tag="rm-awesome-table"] .awesometable-bordered colgroup + thead tr:first-child th:first-child,rm-awesome-table .awesometable-bordered colgroup + tbody tr:first-child td:first-child, [riot-tag="rm-awesome-table"] .awesometable-bordered colgroup + tbody tr:first-child td:first-child{ -webkit-border-top-left-radius: 4px; -moz-border-radius-topleft: 4px; border-top-left-radius: 4px; } rm-awesome-table .awesometable-bordered caption + thead tr:first-child th:last-child, [riot-tag="rm-awesome-table"] .awesometable-bordered caption + thead tr:first-child th:last-child,rm-awesome-table .awesometable-bordered caption + tbody tr:first-child td:last-child, [riot-tag="rm-awesome-table"] .awesometable-bordered caption + tbody tr:first-child td:last-child,rm-awesome-table .awesometable-bordered colgroup + thead tr:first-child th:last-child, [riot-tag="rm-awesome-table"] .awesometable-bordered colgroup + thead tr:first-child th:last-child,rm-awesome-table .awesometable-bordered colgroup + tbody tr:first-child td:last-child, [riot-tag="rm-awesome-table"] .awesometable-bordered colgroup + tbody tr:first-child td:last-child{ -webkit-border-top-right-radius: 4px; -moz-border-radius-topright: 4px; border-top-right-radius: 4px; } rm-awesome-table .awesometable-striped tbody tr:nth-child(odd) td, [riot-tag="rm-awesome-table"] .awesometable-striped tbody tr:nth-child(odd) td{ background-color: #F6F6F6; } rm-awesome-table .awesometable-hover tbody tr:hover td, [riot-tag="rm-awesome-table"] .awesometable-hover tbody tr:hover td,rm-awesome-table .awesometable-hover tbody tr:hover th, [riot-tag="rm-awesome-table"] .awesometable-hover tbody tr:hover th{ background-color: #f3f3f3; } rm-awesome-table .awesometable tr.foot td, [riot-tag="rm-awesome-table"] .awesometable tr.foot td{ background: #eee; font-weight: bold; } rm-awesome-table table td[class*="span"], [riot-tag="rm-awesome-table"] table td[class*="span"],rm-awesome-table table th[class*="span"], [riot-tag="rm-awesome-table"] table th[class*="span"],rm-awesome-table .row-fluid table td[class*="span"], [riot-tag="rm-awesome-table"] .row-fluid table td[class*="span"],rm-awesome-table .row-fluid table th[class*="span"], [riot-tag="rm-awesome-table"] .row-fluid table th[class*="span"]{ display: table-cell; float: none; margin-left: 0; } rm-awesome-table .awesometable td.span1, [riot-tag="rm-awesome-table"] .awesometable td.span1,rm-awesome-table .awesometable th.span1, [riot-tag="rm-awesome-table"] .awesometable th.span1{ float: none; width: 44px; margin-left: 0; } rm-awesome-table .awesometable td.span2, [riot-tag="rm-awesome-table"] .awesometable td.span2,rm-awesome-table .awesometable th.span2, [riot-tag="rm-awesome-table"] .awesometable th.span2{ float: none; width: 124px; margin-left: 0; } rm-awesome-table .awesometable td.span3, [riot-tag="rm-awesome-table"] .awesometable td.span3,rm-awesome-table .awesometable th.span3, [riot-tag="rm-awesome-table"] .awesometable th.span3{ float: none; width: 204px; margin-left: 0; } rm-awesome-table .awesometable td.span4, [riot-tag="rm-awesome-table"] .awesometable td.span4,rm-awesome-table .awesometable th.span4, [riot-tag="rm-awesome-table"] .awesometable th.span4{ float: none; width: 284px; margin-left: 0; } rm-awesome-table .awesometable td.span5, [riot-tag="rm-awesome-table"] .awesometable td.span5,rm-awesome-table .awesometable th.span5, [riot-tag="rm-awesome-table"] .awesometable th.span5{ float: none; width: 364px; margin-left: 0; } rm-awesome-table .awesometable td.span6, [riot-tag="rm-awesome-table"] .awesometable td.span6,rm-awesome-table .awesometable th.span6, [riot-tag="rm-awesome-table"] .awesometable th.span6{ float: none; width: 444px; margin-left: 0; } rm-awesome-table .awesometable td.span7, [riot-tag="rm-awesome-table"] .awesometable td.span7,rm-awesome-table .awesometable th.span7, [riot-tag="rm-awesome-table"] .awesometable th.span7{ float: none; width: 524px; margin-left: 0; } rm-awesome-table .awesometable td.span8, [riot-tag="rm-awesome-table"] .awesometable td.span8,rm-awesome-table .awesometable th.span8, [riot-tag="rm-awesome-table"] .awesometable th.span8{ float: none; width: 604px; margin-left: 0; } rm-awesome-table .awesometable td.span9, [riot-tag="rm-awesome-table"] .awesometable td.span9,rm-awesome-table .awesometable th.span9, [riot-tag="rm-awesome-table"] .awesometable th.span9{ float: none; width: 684px; margin-left: 0; } rm-awesome-table .awesometable td.span10, [riot-tag="rm-awesome-table"] .awesometable td.span10,rm-awesome-table .awesometable th.span10, [riot-tag="rm-awesome-table"] .awesometable th.span10{ float: none; width: 764px; margin-left: 0; } rm-awesome-table .awesometable td.span11, [riot-tag="rm-awesome-table"] .awesometable td.span11,rm-awesome-table .awesometable th.span11, [riot-tag="rm-awesome-table"] .awesometable th.span11{ float: none; width: 844px; margin-left: 0; } rm-awesome-table .awesometable td.span12, [riot-tag="rm-awesome-table"] .awesometable td.span12,rm-awesome-table .awesometable th.span12, [riot-tag="rm-awesome-table"] .awesometable th.span12{ float: none; width: 924px; margin-left: 0; } rm-awesome-table .awesometable tbody tr.success td, [riot-tag="rm-awesome-table"] .awesometable tbody tr.success td{ background-color: #dff0d8; } rm-awesome-table .awesometable tbody tr.error td, [riot-tag="rm-awesome-table"] .awesometable tbody tr.error td{ background-color: #f2dede; } rm-awesome-table .awesometable tbody tr.warning td, [riot-tag="rm-awesome-table"] .awesometable tbody tr.warning td{ background-color: #fcf8e3; } rm-awesome-table .awesometable tbody tr.info td, [riot-tag="rm-awesome-table"] .awesometable tbody tr.info td{ background-color: #d9edf7; } rm-awesome-table .awesometable-hover tbody tr.success:hover td, [riot-tag="rm-awesome-table"] .awesometable-hover tbody tr.success:hover td{ background-color: #d0e9c6; } rm-awesome-table .awesometable-hover tbody tr.error:hover td, [riot-tag="rm-awesome-table"] .awesometable-hover tbody tr.error:hover td{ background-color: #ebcccc; } rm-awesome-table .awesometable-hover tbody tr.warning:hover td, [riot-tag="rm-awesome-table"] .awesometable-hover tbody tr.warning:hover td{ background-color: #faf2cc; } rm-awesome-table .awesometable-hover tbody tr.info:hover td, [riot-tag="rm-awesome-table"] .awesometable-hover tbody tr.info:hover td{ background-color: #c4e3f3; } rm-awesome-table .awesometable tr.awesome-section:nth-child(odd), [riot-tag="rm-awesome-table"] .awesometable tr.awesome-section:nth-child(odd),rm-awesome-table .awesometable tr.awesome-section:nth-child(even), [riot-tag="rm-awesome-table"] .awesometable tr.awesome-section:nth-child(even){ background: #eee; font-weight: bold; color: #000; } rm-awesome-table .awesometable tr.awesome-section td, [riot-tag="rm-awesome-table"] .awesometable tr.awesome-section td{ font-weight: bold; font-size: 15px; } rm-awesome-table .awesometable tr.awesome-section2, [riot-tag="rm-awesome-table"] .awesometable tr.awesome-section2{ background-color: black; color: #EEE; } rm-awesome-table .awesometable div.show-on-hover, [riot-tag="rm-awesome-table"] .awesometable div.show-on-hover{ visibility: hidden; opacity:0; } rm-awesome-table .awesometable tr:hover .show-on-hover, [riot-tag="rm-awesome-table"] .awesometable tr:hover .show-on-hover{ visibility: visible; opacity: 100; } rm-awesome-table .awesometable-rowhover tr:hover td, [riot-tag="rm-awesome-table"] .awesometable-rowhover tr:hover td{ border-top: 1px solid #999; border-bottom: 1px solid #999; } rm-awesome-table .awesometable-rowhover tr:hover td:first-child, [riot-tag="rm-awesome-table"] .awesometable-rowhover tr:hover td:first-child{ border-left: 1px solid #999; } rm-awesome-table .awesometable-rowhover tr:hover td:last-child, [riot-tag="rm-awesome-table"] .awesometable-rowhover tr:hover td:last-child{ border-right: 1px solid #999; } rm-awesome-table .awesometable .head-multiple td, [riot-tag="rm-awesome-table"] .awesometable .head-multiple td{ background-color: #E9E9E9; } rm-awesome-table .awesometable .head-single td, [riot-tag="rm-awesome-table"] .awesometable .head-single td{ background-color: #E9E9E9; } rm-awesome-table .awesometable .sub-ticket td, [riot-tag="rm-awesome-table"] .awesometable .sub-ticket td{ font-size: .8em; color: #333; background-color: white; padding-top: 3px; padding-bottom: 3px; } rm-awesome-table .awesometable .sub-ticket td:first-child, [riot-tag="rm-awesome-table"] .awesometable .sub-ticket td:first-child{ padding-left: 25px; } rm-awesome-table .awesometable .boldfoot td, [riot-tag="rm-awesome-table"] .awesometable .boldfoot td{ font-weight: bold; } rm-awesome-table .awesometable .reversed-footer td, [riot-tag="rm-awesome-table"] .awesometable .reversed-footer td{ font-size: 1.1em; font-weight: bold; } rm-awesome-table .awesometable .reversed-footer.small td, [riot-tag="rm-awesome-table"] .awesometable .reversed-footer.small td{ padding-top: 3px; padding-bottom: 3px; font-size: .83em; background-color: #CCC; } rm-awesome-table .awesometable.table td.span12, [riot-tag="rm-awesome-table"] .awesometable.table td.span12,rm-awesome-table .awesometable.table th.span12, [riot-tag="rm-awesome-table"] .awesometable.table th.span12{ float: none; width: 924px; margin-left: 0; } rm-awesome-table .awesometable.table tbody tr.success > td, [riot-tag="rm-awesome-table"] .awesometable.table tbody tr.success > td{ background-color: #dff0d8; } rm-awesome-table .awesometable.table tbody tr.error > td, [riot-tag="rm-awesome-table"] .awesometable.table tbody tr.error > td{ background-color: #f2dede; } rm-awesome-table .awesometable.table tbody tr.warning > td, [riot-tag="rm-awesome-table"] .awesometable.table tbody tr.warning > td{ background-color: #fcf8e3; } rm-awesome-table .awesometable.table tbody tr.info > td, [riot-tag="rm-awesome-table"] .awesometable.table tbody tr.info > td{ background-color: #d9edf7; } rm-awesome-table .awesometable.table-hover tbody tr.success:hover > td, [riot-tag="rm-awesome-table"] .awesometable.table-hover tbody tr.success:hover > td{ background-color: #d0e9c6; } rm-awesome-table .awesometable.table-hover tbody tr.error:hover > td, [riot-tag="rm-awesome-table"] .awesometable.table-hover tbody tr.error:hover > td{ background-color: #ebcccc; } rm-awesome-table .awesometable.table-hover tbody tr.warning:hover > td, [riot-tag="rm-awesome-table"] .awesometable.table-hover tbody tr.warning:hover > td{ background-color: #faf2cc; } rm-awesome-table .awesometable.table-hover tbody tr.info:hover > td, [riot-tag="rm-awesome-table"] .awesometable.table-hover tbody tr.info:hover > td{ background-color: #c4e3f3; } rm-awesome-table .awesometable-nc tr.head th, [riot-tag="rm-awesome-table"] .awesometable-nc tr.head th{ background-color: #f0f0f0; }', function(opts) {
